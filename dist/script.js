     ...
     */ !(function (t, n) {
      ...
      (k.fn = k.prototype =
        ...
        k.extend({
          ...
          makeArray: function (e, t) {
            ...
            return (
              null != e &&
                (C(Object(e)) ? k.merge(n, 'string' == typeof e ? [e] : e) : u.call(n, e)),
              n
            );
          },
      ...
      var $ =
        ...
        (function (e) {
          ...
          try {
            N.apply((L = P.call(b.childNodes)), b.childNodes), L[b.childNodes.length].nodeType;
          } catch (e) {
            N = {
              apply: L.length
                ? function (e, t) {
          ...
          function ae(e, t, i, o) {
            ...
            if (((i = i || []), 'string' != typeof e || !e || (1 !== T && 9 !== T && 11 !== T)))
              return i;
            if (!o && ((t ? t.ownerDocument || t : b) !== f && p(t), (t = t || f), v)) {
              if (11 !== T && (d = Z.exec(e)))
                if ((r = d[1])) {
                  if (9 === T) {
          ...
          (ae.matchesSelector = function (e, t) {
            if (
              ...
              n.matchesSelector && v && !E[t + ' '] && (!y || !y.test(t)) && (!g || !g.test(t)))
            )
              try {
                var i = m.call(e, t);
                          ...
                          if (((h = [s ? g.firstChild : g.lastChild]), s && m)) {
                            ...
                            for (
                              ...
                              ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) ||
                                ...
                                (m &&
                                  ((u =
                                    (d = p[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[
                                    e
                                  ] = [T, w]),
                                p !== t));
              ...
              : function (t, n, l) {
                  ...
                  if (l) {
                    ...
                    for (; (t = t[i]); )
                      if (1 === t.nodeType || s)
                        if (
                          ((u = (d = t[x] || (t[x] = {}))[t.uniqueID] || (d[t.uniqueID] = {})),
                      ...
                      var n = t.length > 0,
                        ...
                        r = function (r, s, a, l, u) {
                          ...
                          if (((y += m), n && m !== y)) {
                            ...
                            N.apply(l, x),
                              u && !r && x.length > 0 && y + t.length > 1 && ae.uniqueSort(l);
                          }
                          return u && ((T = S), (c = b)), w;
                        };
                      return n ? ce(r) : r;
        ...
        if (((n = n || N), 'string' == typeof e)) {
          ...
          if (i[1]) {
            if (
              ...
              k.merge(this, k.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : s, !0)),
        ...
        k.each(
          {
            ...
            contents: function (e) {
              return void 0 !== e.contentDocument
                ? e.contentDocument
                : (L(e, 'template') && (e = e.content || e), k.merge([], e.childNodes));
            },
          },
          function (e, t) {
            k.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 && (q[e] || k.uniqueSort(o), H.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          },
                          ...
                          : function () {
                              try {
                                ...
                                k.Deferred.exceptionHook &&
                                  ...
                                  e + 1 >= r &&
                                    (i !== R && ((a = void 0), (l = [n])), t.rejectWith(a, l));
                              }
                            };
                      e
                        ? u()
        ...
        k.extend({
          ...
          ready: function (e) {
            (!0 === e ? --k.readyWait : k.isReady) ||
              ((k.isReady = !0), (!0 !== e && --k.readyWait > 0) || F.resolveWith(s, [k]));
          },
        }),
        (k.ready.then = F.then),
        'complete' === s.readyState || ('loading' !== s.readyState && !s.documentElement.doScroll)
          ? n.setTimeout(k.ready)
          : (s.addEventListener('DOMContentLoaded', B), n.addEventListener('load', B));
      ...
      (J.uid = 1),
        (J.prototype = {
          ...
          remove: function (e, t) {
            ...
            if (void 0 !== i) {
              if (void 0 !== t) {
                n = (t = Array.isArray(t) ? t.map(V) : (t = V(t)) in i ? [t] : t.match(I) || [])
                  .length;
                for (; n--; ) delete i[t[n]];
              }
          ...
          queue: function (e, t, n) {
            ...
            if (e)
              return (
                (t = (t || 'fx') + 'queue'),
                (i = K.get(e, t)),
                n && (!i || Array.isArray(n) ? (i = K.access(e, t, k.makeArray(n))) : i.push(n)),
                i || []
              );
          },
      ...
      function he(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++)
          (i = e[r]).style &&
            ...
            t
              ? ('none' === n &&
                  ((o[r] = K.get(i, 'display') || null), o[r] || (i.style.display = '')),
      ...
      function Se(e, t, n, i, o) {
        ...
        for (d.textContent = '', f = 0; (r = p[f++]); )
          ...
          else if (((c = ae(r)), (s = we(d.appendChild(r), 'script')), c && xe(s), n))
      ...
      (k.event = {
        ...
        remove: function (e, t, n, i, o) {
          ...
          if (g && (l = g.events)) {
            for (c = (t = (t || '').match(I) || ['']).length; c--; )
              if (
                ((f = v = (a = Ee.exec(t[c]) || [])[1]), (h = (a[2] || '').split('.').sort()), f)
              ) {
                for (
                  d = k.event.special[f] || {},
        ...
        special: {
          ...
          click: {
            setup: function (e) {
              var t = this || e;
              return ve.test(t.type) && t.click && L(t, 'input') && De(t, 'click', Ae), !1;
            },
            trigger: function (e) {
              var t = this || e;
            ...
            _default: function (e) {
              var t = e.target;
              return (
                (ve.test(t.type) && t.click && L(t, 'input') && K.get(t, 'click')) || L(t, 'a')
              );
            },
          },
          beforeunload: {
      ...
      function We(e, t, n, i) {
        ...
        if (
          ...
          for (a = (s = k.map(we(o, 'script'), Ie)).length; d < p; d++)
            (l = o),
              d !== f && ((l = k.clone(l, !0, !0)), a && k.merge(s, we(l, 'script'))),
              n.call(e[d], l, d);
          if (a)
            for (u = s[s.length - 1].ownerDocument, k.map(s, _e), d = 0; d < a; d++)
              (l = s[d]),
                ye.test(l.type || '') &&
                  ...
                  (l.src && 'module' !== (l.type || '').toLowerCase()
                    ? k._evalUrl &&
                      !l.noModule &&
                      k._evalUrl(l.src, { nonce: l.nonce || l.getAttribute('nonce') })
      ...
      function Fe(e, t, n) {
        for (var i, o = t ? k.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
          n || 1 !== i.nodeType || k.cleanData(we(i)),
            i.parentNode && (n && ae(i) && xe(we(i, 'script')), i.parentNode.removeChild(i));
        return e;
      }
      k.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (!(y.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || k.isXMLDoc(e)))
            for (s = we(a), i = 0, o = (r = we(e)).length; i < o; i++) ze(r[i], s[i]);
          if (t)
            if (n)
              for (r = r || we(e), s = s || we(a), i = 0, o = r.length; i < o; i++) Re(r[i], s[i]);
            else Re(e, a);
          ...
          'margin' === n && (l += k.css(e, n + re[s], !0, o)),
            i
              ? ('content' === n && (l -= k.css(e, 'padding' + re[s], !0, o)),
                'margin' !== n && (l -= k.css(e, 'border' + re[s] + 'Width', !0, o)))
            ...
            return U(
              ...
              function (e, t, n) {
                var i,
                  ...
                  s = 0;
                if (Array.isArray(t)) {
                  for (i = Ue(e), o = t.length; s < o; s++) r[t[s]] = k.css(e, t[s], !1, i);
                  return r;
                }
      ...
      function ht(e, t, n) {
        for (
          var i, o = (vt.tweeners[t] || []).concat(vt.tweeners['*']), r = 0, s = o.length;
          r < s;
          r++
        )
      ...
      function vt(e, t, n) {
        ...
        for (
          ...
          if ((i = vt.prefilters[r].call(c, e, u, c.opts)))
            return m(i.stop) && (k._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return (
          k.map(u, ht, c),
            ...
            if ((l = !k.isEmptyObject(t)) || !k.isEmptyObject(f))
              ...
              f))
                l ||
                  ...
                  v && he([e], !0),
                  p.done(function () {
                    for (i in (v || he([e]), K.remove(e, 'fxshow'), f)) k.style(e, i, f[i]);
                  })),
                  (l = ht(v ? g[i] : 0, i, p)),
          ...
          attr: function (e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
              return void 0 === e.getAttribute
                ? k.prop(e, t, n)
                : ((1 === r && k.isXMLDoc(e)) ||
                    (o = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? gt : void 0)),
                  void 0 !== n
                    ? null === n
        ...
        k.each(k.expr.match.bool.source.match(/\w+/g), function (e, t) {
          ...
          yt[t] = function (e, t, i) {
            var o,
              ...
              s = t.toLowerCase();
            return (
              i || ((r = yt[s]), (yt[s] = o), (o = null != n(e, t, i) ? s : null), (yt[s] = r)), o
            );
          };
        });
        ...
        trigger: function (e, t, i, o) {
          ...
          if (
            ...
            3 !== i.nodeType &&
              ...
              (u = g.indexOf(':') < 0 && 'on' + g),
              ((e = e[k.expando] ? e : new k.Event(g, 'object' == typeof e && e)).isTrigger = o
                ? 2
                : 3),
              (e.namespace = y.join('.')),
      ...
      function Nt(e, t, n, i) {
        ...
        if (Array.isArray(t))
          k.each(t, function (t, o) {
            n || jt.test(e)
              ? i(e, o)
              : Nt(e + '[' + ('object' == typeof o && null != o ? t : '') + ']', o, n, i);
          });
        ...
        k.extend({
          ...
          ajax: function (e, t) {
            ...
            var i,
              ...
              S = {
                ...
                setRequestHeader: function (e, t) {
                  return (
                    null == u && ((e = b[e.toLowerCase()] = b[e.toLowerCase()] || e), (x[e] = t)),
                    this
                  );
                },
            ...
            if (
              ...
              return S;
            for (p in ((d = k.event && h.global) && 0 == k.active++ && k.event.trigger('ajaxStart'),
            ...
            h.hasContent
              ...
              : ((f = h.url.slice(o.length)),
                ...
                !1 === h.cache &&
                  ((o = o.replace(qt, '$1')), (f = (At.test(o) ? '&' : '?') + '_=' + Et++ + f)),
                (h.url = o + f)),
            h.ifModified &&
            ...
            S.setRequestHeader(
              ...
              h.dataTypes[0] && h.accepts[h.dataTypes[0]]
                ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + Wt + '; q=0.01' : '')
                : h.accepts['*'],
            ),
            h.headers))
            ...
            function C(e, t, s, a) {
              ...
              u ||
                ...
                c
                  ? (h.ifModified &&
                      ((b = S.getResponseHeader('Last-Modified')) && (k.lastModified[o] = b),
                ...
                m.fireWith(v, [S, T]),
                d &&
                  (g.trigger('ajaxComplete', [S, h]), --k.active || k.event.trigger('ajaxStop')));
            }
            return S;
          },
      ...
      k.ajaxSetup({
        ...
        (k.parseHTML = function (e, t, n) {
          return 'string' != typeof e
            ...
            : ('boolean' == typeof t && ((n = t), (t = !1)),
              t ||
                (y.createHTMLDocument
                  ? (((i = (t = s.implementation.createHTMLDocument('')).createElement(
                      'base',
        ...
        k.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (e, t) {
          ...
          k.fn[e] = function (i) {
            return U(
              ...
              function (e, i, o) {
                var r;
                if ((w(e) ? (r = e) : 9 === e.nodeType && (r = e.defaultView), void 0 === o))
                  return r ? r[t] : e[i];
        ...
        k.each(['top', 'left'], function (e, t) {
          k.cssHooks[t] = Ye(y.pixelPosition, function (e, n) {
            if (n) return (n = Ge(e, t)), Be.test(n) ? k(e).position()[t] + 'px' : n;
          });
        }),
      ...
      return [
        ...
        function (e, r) {
          ...
          for (var x, b = '', T = 0, k = 0; k < m.length; k++) {
            w = m[k];
            for (
              var S = String(w[0]), C = d(p(a(w.index), h.length), 0), $ = [], E = 1;
              E < w.length;
              E++
            )
  ...
  function (e, t, n) {
    ...
    (h && v) ||
      ...
      'process' == l(g)
        ...
        : y && !p
        ? ((r = (o = new y()).port2), (o.port1.onmessage = k), (i = c(r.postMessage, r, 1)))
          ...
          (L.prototype = {
            ...
            abrupt: function (e, t) {
              ...
              return (
                (s.type = e),
                (s.arg = t),
                r ? ((this.method = 'next'), (this.next = r.finallyLoc), v) : this.complete(s)
              );
            },
  ...
  function (e, t, n) {
    ...
    var r = function () {
        ...
        e('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close'),
          ...
          e('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', !1);
      },
      s =
        (n(33),
        function (e, t, n, i) {
          var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 'block',
      ...
      l = function (e) {
        ...
        var i = 'Завантаження...',
          o = "Дякуємо! Скоро ми з вами зв'яжемося",
          r = 'Щось пішло не так...';
      ...
      u = function (e, t) {
        var n = function (e) {
          ...
          i = function (e) {
            ...
            return { total: t, days: Math.floor(t / 864e5), hours: o, minutes: i, seconds: n };
          };
        !(function (e, t) {
    ...
    window.addEventListener('DOMContentLoaded', function () {
      ...
      c(e),
        ...
        s('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'),
        s('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block'),
        l(e),
        u('.container1', '2025-09-18'),
        d();
    });
  },
]);
